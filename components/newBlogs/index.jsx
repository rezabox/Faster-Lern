      ...
      <div className="container mx-auto py-8">
        <section className="flex flex-col gap-4">
          <header className="flex justify-between items-center ">
            <h2 className="font-semibold text-2xl border-r-white pr-1 text-black">مقالات</h2>
            <div className="flex items-center justify-between gap-5">
              ...
              <Link
                href={"/"}
                className="bg-indigo-500 border-white border-2 px-4 py-2 rounded-md transition-all duration-500 text-white hover:bg-orange-400"
              >
                 برو به بلاگ{" "}
              </Link>
            </div>
